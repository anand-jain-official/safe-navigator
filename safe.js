/**
 * @param {(object|array)} inputObjOrArray input object/array
 * @param {string} keyString string to access inner objects/elements
 * @param {*} fallback any value to fallback to instead of undefined.
 */
